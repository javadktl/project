...
//                   decoration: InputDecoration(
//                       suffixIcon: Icon(Icons.search),
//                       hintText: 'Search Name/Apartment',hintStyle: TextStyle(fontWeight: FontWeight.w300,fontSize: 13),
//                       border: OutlineInputBorder(
//                         borderRadius: BorderRadius.all(Radius.circular(20)),
//                       ))),
//             ),
...
//                     Widget? child) {
//                   // Filter worklist based on search query
//                   List<WorkModel> filteredWorkList = worklist.where((work) {
//                     String name = work.name.toLowerCase();
//                     String apartment = work.apartment.toLowerCase();
//                     String day = work.day.toLowerCase();
//                     // Customize this as per your requirement
//                     return name.contains(keyword) ||
//                         apartment.contains(keyword) ||
//                         day.contains(keyword);
//                   }).toList();
//                   if (filteredWorkList.isEmpty) {
//                     return Center(
//                       child: Text('No Data Availabele'),
//                     );
//                   }
//                   return ListView.separated(
//                     itemBuilder: (context, index) {
...
//         mini: true,
//         onPressed: () async {
//           //List<String> names = await getAllNameAsync();
//           Navigator.of(context)
//               .push(MaterialPageRoute(builder: (context) => AddworkScreen()));
//         },
//         child: Icon(
//           Icons.add,
//           color: Colors.white,
...
//         Text(
//           workdata.name,
//           style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromARGB(255, 149, 28, 19)),
//         ),
//         Text(
//           workdata.apartment,
//           style: TextStyle(color: Colors.white70),
...
//                                   builder: (context) =>
//                                       WorkEditScreen(editwork: workdata)));
//                             },
//                             backgroundColor: Colors.green,
//                           ),
//                         ]),

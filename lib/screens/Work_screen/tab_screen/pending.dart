                ...
                builder: (BuildContext ctx, List<WorkModel> worklist,
                  ...
                  return ListView.builder(
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context)=>WorkDetaileView(workdetails: worklist[index]))),
                        child: Container(  height: smallestHeight * 1.1,
                          width: screenWidth,
